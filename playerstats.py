...
Zacke_Swiftfoot = playerstats("Zacke Swiftfoot", 50, 18, 10, 0)
Jacke_Bigfoot = playerstats("Jacke Bigfoot", 70, 12, 15, 0)
Wilson_Slowfoot = playerstats("Wilson Slowfoot", 55, 15, 12, 0)
